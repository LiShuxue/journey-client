<template>
  <div class="comments-wrapper">
    ...
    <div class="comments-publish">
      <el-input placeholder="name" v-model="name" size="mini" class="arthur-info"> </el-input>
      <el-input placeholder="email" v-model="email" size="mini" class="arthur-info"> </el-input>
...
export default {
  ...
  methods: {
    addComments(parentId, replyName) {
      ...
      this.axios
        .post(API.notRequireAuth.addComments, { blog_id: this.blog._id, replyName, parent_id: parentId, comment })
        .then(() => {
